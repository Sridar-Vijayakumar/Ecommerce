    ...
    <footer className="bg-ink-900 text-slate-300">
      <div className="page-shell grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-5">
        <div className="sm:col-span-2">
          ...
          <a href="mailto:support@shopease.com" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold hover:text-brand-500"><Mail size={17}/> support@shopease.com</a>
